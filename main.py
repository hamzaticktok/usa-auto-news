...
# 2. تحميل ملفات وسائط إذا كانت المجلدات فارغة (للتجربة)
def download_assets():
...
# 3. معالجة الفيديو وتحويله إلى صيغة يوتيوب
...
# 5. حفظ الفيديو النهائي في مجلد output
output_path = f"output/usa_trends_{datetime.now().strftime('%Y%m%d')}.mp4"
